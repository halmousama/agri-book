...
import seaMd from "../../../content/Sea.md?raw";
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32">
      <div className="flex justify-between items-center mb-8 text-sm text-slate-500 dark:text-slate-400">
        ...
        <span>الفصل 6 من 6 — النسخة المرجعية</span>
      </div>
      ...
      <div
        ...
        prose-th:bg-blue-600 prose-th:text-white prose-th:p-3 prose-th:text-right
        ...
        prose-tr:even:bg-blue-50 dark:prose-tr:even:bg-blue-900/10
        prose-code:bg-slate-100 dark:prose-code:bg-slate-800 prose-code:text-blue-700 dark:prose-code:text-blue-300 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm
        prose-hr:border-slate-200 dark:prose-hr:border-slate-700 prose-hr:my-8
        prose-blockquote:border-r-4 prose-blockquote:border-blue-400 prose-blockquote:bg-blue-50 dark:prose-blockquote:bg-blue-900/20 prose-blockquote:pr-4 prose-blockquote:py-2 prose-blockquote:my-4 prose-blockquote:text-slate-600 dark:prose-blockquote:text-slate-400
      "
      >
        <ReactMarkdown remarkPlugins={[remarkGfm]}>{seaMd}</ReactMarkdown>
      </div>

      <div className="mt-16 flex justify-between items-center border-t border-slate-100 dark:border-slate-700 pt-8">
        <Link to="/sea/book-sea/chapter05">
          <Button variant="outline" className="flex items-center gap-2">
            <ArrowRight size={18} /> السابق: الملاحق
          </Button>
        </Link>
