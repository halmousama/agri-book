  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
        ...
        <div className="prose-custom">
            ...
            <div className="bg-amber-50 p-6 rounded-2xl border-r-4 border-amber-500 my-8">
                <h3 className="text-amber-800 font-bold text-lg mt-0 mb-2 flex items-center gap-2">
                    <Rainbow size={20} />
                    لماذا النبات أخضر؟
                </h3>
