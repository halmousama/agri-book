  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
      ...
      <div className="prose-custom">
        ...
        <div
          className="bg-slate-100 dark:bg-slate-800 text-emerald-600 dark:text-emerald-400 p-4 rounded-xl font-mono text-center text-lg my-6"
          dir="ltr"
        >
        ...
        <div className="flex items-start gap-4 p-4 border rounded-xl bg-slate-50 dark:bg-slate-800 shadow-sm mt-8">
          ...
          <div>
            <h4 className="font-bold text-slate-900 dark:text-slate-100 mt-0">وفر مالك</h4>
      ...
      <div className="mt-16 flex justify-between items-center border-t border-slate-100 dark:border-slate-700 pt-8">
        <Link to="/agri/book-02-science-toolbox/chapter09">
