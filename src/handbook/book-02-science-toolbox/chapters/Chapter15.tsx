  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
      ...
      <div className="prose-custom">
        ...
        <div className="bg-stone-50 p-6 rounded-2xl border-r-4 border-stone-500 my-8">
          <h3 className="text-stone-800 font-bold text-lg mt-0 mb-2 flex items-center gap-2">
            <Recycle size={20} />
        ...
        <div className="flex items-start gap-4 p-4 border rounded-xl bg-slate-50 shadow-sm mt-8">
          ...
          <div>
            <h4 className="font-bold text-slate-900 mt-0">
              دليل النجاح: الحرارة
            </h4>
        ...
        >
          ...
          <p className="text-blue-100 text-lg mb-8 max-w-xl mx-auto">
            لقد أتممت "الكتاب الثاني: العدة العلمية". أنت الآن لست مجرد فلاح
      ...
      <div className="mt-16 flex justify-between items-center border-t border-slate-100 pt-8">
        ...
        <Link to="/book-03-systems-engineering">
          <Button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700">
            الكتاب الثالث: هندسة الأنظمة <ArrowLeft size={18} />
          </Button>
        </Link>
      </div>
    </div>
