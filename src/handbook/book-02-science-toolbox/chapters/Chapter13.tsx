  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
      ...
      <div className="prose-custom">
        ...
        <div className="bg-rose-50 p-6 rounded-2xl border-r-4 border-rose-500 my-8">
        ...
        <div className="flex items-start gap-4 p-4 border rounded-xl bg-amber-50 shadow-sm mt-8">
          <div className="bg-white p-2 rounded-full shadow-sm text-amber-600">
            <ShieldAlert size={24} />
          </div>
          <div>
            <h4 className="font-bold text-slate-900 mt-0">الفراغ البيولوجي</h4>
