  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
        ...
        <div className="prose-custom">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border-r-4 border-slate-500 my-8">
                <h3 className="text-slate-800 font-bold text-lg mt-0 mb-2 flex items-center gap-2">
                    <CloudFog size={20} />
            ...
            <div className="flex items-start gap-4 p-4 border rounded-xl bg-blue-50 shadow-sm mt-8">
