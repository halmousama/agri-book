  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
        ...
        <div className="prose-custom">
            ...
            <div className="bg-slate-800 text-white p-6 rounded-xl font-mono text-center text-lg my-6 shadow-xl"
            ...
            style={{background:'linear-gradient(to bottom, #16a34a, #059669)'}}>
                ...
                <p className="text-green-100 text-lg mb-8 max-w-xl mx-auto">
                    لقد أتممت "الكتاب الأول: منطق الطبيعة".
        ...
        <div className="mt-16 flex justify-between items-center border-t border-slate-100 pt-8">
            ...
            <Link to="/book-02-science-toolbox">
                <Button className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700">
                    الكتاب الثاني: العدة العلمية <ArrowLeft size={18} />
                </Button>
            </Link>
        </div>
    </div>
