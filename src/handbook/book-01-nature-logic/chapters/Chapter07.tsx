    ...
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
        ...
        <div className="prose-custom">
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-amber-50 dark:bg-amber-900/30 p-6 rounded-2xl border border-amber-100 dark:border-amber-800">
                    <h3 className="text-amber-700 dark:text-amber-300 font-bold text-lg mt-0 mb-2 flex items-center gap-2">
                        <Truck size={20} />
                ...
                <div className="bg-blue-50 dark:bg-blue-900/30 p-6 rounded-2xl border border-blue-100 dark:border-blue-800">
                    <h3 className="text-blue-700 dark:text-blue-300 font-bold text-lg mt-0 mb-2 flex items-center gap-2">
                        <ShieldCheck size={20} />
            ...
            <div className="flex items-start gap-4 p-4 border rounded-xl bg-slate-50 dark:bg-slate-800 shadow-sm mt-8">
                ...
                <div>
                    <h4 className="font-bold text-slate-900 dark:text-slate-100 mt-0">نصيحة المهندس</h4>
