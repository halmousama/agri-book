  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-screen pb-32 font-cairo">
        ...
        <div className="prose-custom">
            ...
            <div className="bg-sky-50 p-6 rounded-2xl border-r-4 border-sky-500 my-8">
                <h3 className="text-sky-700 font-bold text-lg mt-0 mb-2 flex items-center gap-2">
                    <Wind size={20} />
                    نظرية الشد (The Pull)
                </h3>
            ...
            <ul>
                <li>
                    ...
                    <br/>
                    <span className="text-sm text-slate-500">⚠ هذا يسبب مشاكل في البيوت المحمية (مثل نقص الكالسيوم وتعفن الثمار).</span>
                </li>
                <li>
            ...
            <div className="flex items-start gap-4 p-4 border rounded-xl bg-slate-50 shadow-sm mt-8">
                ...
                <div>
                    <h4 className="font-bold text-slate-900 mt-0">معلومة للمحترفين</h4>
