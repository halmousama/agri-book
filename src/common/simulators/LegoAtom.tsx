      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch lg:items-start">
          ...
          <div className="flex-1 space-y-3">
            ...
            <button
              onClick={reset}
              className="w-full py-2.5 bg-slate-700 hover:bg-slate-800 text-white rounded-xl font-bold text-sm transition-all active:scale-[0.97] flex items-center justify-center gap-1.5 shadow-md"
            >
              <RotateCcw size={16} />
