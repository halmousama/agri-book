      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-800 leading-tight">مختبر التبخر — حالات الماء</h3>
              <p className="text-xs text-slate-500">صلب ↔ سائل ↔ غاز — دورة الماء في الطبيعة</p>
            </div>
          </div>
          <motion.div
            className={cn(
