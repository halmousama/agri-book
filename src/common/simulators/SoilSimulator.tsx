      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-800 leading-tight">مختبر التربة والري — هيدرولوجيا</h3>
              <p className="text-xs text-slate-500">محاكاة تسرب الماء في أنواع التربة المختلفة</p>
            </div>
          </div>
          <motion.div
            className={cn(
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          {/* ===== المشهد الفلاحي (SVG) ===== */}
          <div className="w-full lg:w-80 h-96 shrink-0 overflow-hidden rounded-2xl bg-white border border-slate-200 shadow-md p-2 relative">
