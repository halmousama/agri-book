...
export const PhosphorusSimulator = () => {
  ...
  return (
    <div className="overflow-x-hidden bg-gradient-to-br from-white to-yellow-50/40 p-6 md:p-8 rounded-3xl shadow-xl border border-yellow-100/60 my-10 font-cairo relative">
