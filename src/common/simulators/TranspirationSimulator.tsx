      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200 leading-tight">مضخة النتح الطبيعية — Transpiration</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">كيف يسحب النبات الماء من الجذور إلى الأوراق</p>
            </div>
          </div>
          <motion.div
            className={cn(
